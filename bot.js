...
client.user.setGame(`NEW YORK RP I GTA SAN ANDREAS`)
                ...
                if(!message.member.hasPermission("ADMINISTRATOR")) {
                    ...
                    if(!args) {
                        ...
                        message.channel.send(`**هل أنت متأكد من إرسالك البرودكاست؟\nمحتوى البرودكاست: \`${args}\`**`).then(m => {
                            ...
                            yes.on("collect", v => {
                                m.delete();
                                    message.channel.send(`:ballot_box_with_check: | تم .... ${message.guild.memberCount} الأعضاء إستلامو الرسالة  `).then(msg => msg.delete(5000));
                                        message.guild.members.forEach(member => {
                                            let bc = new Discord.RichEmbed()
                                            .setColor("#000000")
                                            .setTitle("رسالة من طرف نيويورك سيتي رول بلاي")
                                           
                                            .setThumbnail("https://i.ibb.co/LPBxKfc/e41e827336e592fc084566be2bff2665-new-york-skyline-badge-by-vexels-1.png")                                                       
...
client.on("message", async message => {
    if(message.content.startsWith(prefix + "invite")) {
        let invite = new Discord.RichEmbed()
            ...
            .setThumbnail(message.author.avatarURL)
            .setTitle("**إضغط هنا لكي تدعو البوت إلى سيرفيرك - باند غانغ  :sparkling_heart:**")
    ...
    if(message.content.startsWith(prefix + "help")) {
        let help = new Discord.RichEmbed()
           ...
           :الكومندات
            ...
            رابط سيرفر الدعم الفني LSG : https://discord.gg/DHkvHfz
            **`);
